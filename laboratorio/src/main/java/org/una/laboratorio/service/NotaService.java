...
public class NotaService {
    public static <T> List<NotaDTO> ListFromConnection(String urlstring, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<ArrayList<NotaDTO>>() {
        }.getType();
    ...
    public static <T> NotaDTO FromConnectionID(String urlstring,String id, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<NotaDTO>() {
        }.getType();
