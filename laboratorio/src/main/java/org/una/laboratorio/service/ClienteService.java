...
public class ClienteService {
    ...
    public static <T> ClienteDTO FromConnectionID(String urlstring,String id, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<ClienteDTO>() {
        }.getType();
