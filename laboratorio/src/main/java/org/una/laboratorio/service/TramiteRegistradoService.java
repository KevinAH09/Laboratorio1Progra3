...
public class TramiteRegistradoService {
    ...
    public static <T> TramiteRegistradoDTO FromConnectionID(String urlstring,String id, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<TramiteRegistradoDTO>() {
        }.getType();
