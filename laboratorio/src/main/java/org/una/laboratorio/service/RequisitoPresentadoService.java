...
public class RequisitoPresentadoService {
    ...
    public static <T> RequisitoPresentadoDTO FromConnectionID(String urlstring,String id, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<RequisitoPresentadoDTO>() {
        }.getType();
