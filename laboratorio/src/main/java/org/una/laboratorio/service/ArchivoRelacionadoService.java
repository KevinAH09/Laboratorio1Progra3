...
public class ArchivoRelacionadoService {
    public static <T> List<ArchivoRelacionadoDTO> ListFromConnection(String urlstring, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<ArrayList<ArchivoRelacionadoDTO>>() {
        }.getType();
    ...
    public static <T> ArchivoRelacionadoDTO FromConnectionID(String urlstring,String id, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<ArchivoRelacionadoDTO>() {
        }.getType();
