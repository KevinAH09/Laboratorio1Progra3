...
public class RequisitoService {
    public static <T> List<RequisitoDTO> ListFromConnection(String urlstring, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<ArrayList<RequisitoDTO>>() {
        }.getType();
    ...
    public static <T> RequisitoDTO FromConnectionID(String urlstring,String id, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<RequisitoDTO>() {
        }.getType();
