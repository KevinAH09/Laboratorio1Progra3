...
public class TramiteEstadoService {
    public static <T> List<TramiteEstadoDTO> ListFromConnection(String urlstring, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<ArrayList<TramiteEstadoDTO>>() {
        }.getType();
    ...
    public static <T> TramiteEstadoDTO FromConnectionID(String urlstring,String id, Class<T> type) throws MalformedURLException, IOException {
        Gson gson = new Gson();
        Type listtype = new TypeToken<TramiteEstadoDTO>() {
        }.getType();
